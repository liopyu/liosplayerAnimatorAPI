...
public abstract class PlayerMixin_LioLibOnly implements GeoEntity {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, ModInit.MOD_ID, state -> PlayState.STOP).setOverrideEasingTypeFunction((player) -> ModLioLibUtilsClient.getEasingTypeForID((Player)(Object)this)));
    }
